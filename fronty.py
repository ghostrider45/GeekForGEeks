...
heart_disease_model = pickle.load(open('C:/Users/nitya/OneDrive/Desktop/HART/heart_disease_model.sav','rb'))

with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System',
                          ['Heart Disease Prediction',],icons=['heart'], default_index=0)
    ...
    if selected == 'Heart Disease Prediction':
        ...
        if st.button('Heart Disease Test Result'):
            ...
            if len(heart_prediction) > 0 and heart_prediction[0] == 1:
